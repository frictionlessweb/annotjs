...
const useCreateAnnotation = (config) => {
  ...
  const onMouseUp = React.useCallback(() => {
    const { creationBounds } = annotationState;
    const finalCoordinates =
      translateCreationBoundsToFinalCoordinates(creationBounds);
    ...
    setAnnotationState({ creationBounds: null });
  }, [tokens, onCreateAnnotation, annotationState]);
...
export const CreateAnnotationLayer = (props) => {
  ...
  return h("div", {
    ...
    children: [
      h("div", {
        key: annotationState.creationBounds
          ? serializeBounds(annotationState.creationBounds)
          : "null",
        style: {
          position: "absolute",
          ...translateCreationBoundsToInProgressCSS(
